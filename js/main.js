...
function closeNav() {   
  ...
  document.getElementById("button-know").style.border = "0 solid #ffffff"
  ...
  document.getElementById("button-find").style.border = "0 solid #ffffff"
  ...
  document.getElementById("button-blog").style.border = "0 solid #ffffff"
  ...
  document.getElementById("button-cont").style.border = "0 solid #ffffff"
